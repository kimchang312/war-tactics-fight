...
public class GameTextData
{
    ...
    private static readonly Dictionary<int, (string[] Names, string[] Descriptions)> dataMap = new Dictionary<int, (string[], string[])>
    {
        ...
        // 스탯
        { 98, (new[] { "병종", "Branch", "" }, new[] { "병사의 종류.\n 같은 병종 끼리는 비슷한 특성, 기술을 가진다.", "", "" }) },
                { 99, (new[] { "태그", "Tag", "" }, new[] { "유닛이 속해 있는 집단.", "", "" }) },
        { 100, (new[] { "기동력", "Mobility", "" }, new[] { "유닛의 회피와 관련된 능력치.", "", "" }) },
        { 101, (new[] { "체력", "Health", "体力" }, new[] { "유닛이 보유한 체력.\n 전투중에 0이되면 죽는다.", "", "" }) },
        { 102, (new[] { "장갑", "Armor", "装甲" },  new[] { "유닛의 방어력.\n 전투중 적의 피해량을 감소 시켜준다.", "", "" }) },
        { 103, (new[] { "공격력", "Attack Damage", "攻撃力" },  new[] { "유닛의 공격력.\n 전투중 피해량을 담당한다.", "", "" }) },
        { 104, (new[] { "사거리", "Range", "射程" },  new[] { "유닛의 공격 가능 범위.\n 사거리가 2이상이라면 후열에서도 공격 가능하다.", "", "" }) },
        { 105, (new[] { "대기병", "Anti Calvary", "対騎兵" },  new[] { "적이 기병일 때 추가 피해량.", "", "" }) },
        { 106, (new[] { "회피", "Dodge", "回避" }, new[] { "적의 공격을 피할 확률.", "", "" }) },
        { 107, (new[] { "기력", "Energy", "" }, new[]{"기력. 전투에 참가할 때마다 1 감소. 0이 되면 유닛이 영구적으로 사망한다."}) },
        { 108, (new[] { "희귀도", "Rarity", "" }, new[] { "높을 수록 획득 난도가 높다.", "", "" }) },
        ...
        { 171, (new[] { "연회", "Banquet", "" }, new[] { "부대 전체 사기를 20만큼 증가시킵니다.", "", "" }) },
        { 172, (new[] { "훈련", "Traning", "" }, new[] { "다음 전술 개량의 비용이 0이 됩니다.", "", "" }) },
        { 173, (new[] { "금화", "Gold", "" }, new[] { "다양한 교환에 사용할 수 있다.", "", "" }) },
        { 174, (new[] { "리롤", "Gold", "" }, new[] { "무작위 선택지를 다시 받을 수 있다.", "", "" }) },
