...
public static class WarRelicDatabase
{
    ...
    static WarRelicDatabase()
    {
        ...
        relics.Add(new WarRelic(2, "단단한 모루", 1, "군사 아카데미의 강화 비용이 20% 감소한다.", RelicType.SpecialEffect, () => SolidAnvil()));
        ...
        relics.Add(new WarRelic(8, "기이한 돋보기", 1, "보물을 열거나, 보스에게 승리할 때마다 리롤을 1회 얻는다.", RelicType.SpecialEffect, () => ArchaeologyKit()));
        ...
        relics.Add(new WarRelic(56, "혼돈의 주사위", 10, "아군 유닛들의 체력, 공격력이 매 전투마다 최소 60%에서 최대 200%까지 무작위로 분배된다.", RelicType.StateBoost, () => Relic56()));
